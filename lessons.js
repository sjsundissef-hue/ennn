const LESSONS = {
  ...
  "irreg-verbs-1": {
    id:"irreg-verbs-1",hidden:true,title:"Verbes irréguliers — Groupe 1",subtitle:"⚠️ Les 3 formes toutes différentes",icon:"⚠️",color:"#f59e0b",questionCount:20,hasQuiz:true,
    questions:[
  ...
  "irreg-verbs-2": {
    id:"irreg-verbs-2",hidden:true,title:"Verbes irréguliers — Groupe 2",subtitle:"✅ Passé simple = Participe passé",icon:"🟩",color:"#10b981",questionCount:20,hasQuiz:true,
    questions:[
      {fr:"Passé simple (= PP) de : BRING",en:["brought"]},
      {fr:"Passé simple (= PP) de : BUILD",en:["built"]},
      {fr:"Passé simple (= PP) de : BUY",en:["bought"]},
      {fr:"Passé simple (= PP) de : CATCH",en:["caught"]},
      {fr:"Passé simple (= PP) de : FEEL",en:["felt"]},
      {fr:"Passé simple (= PP) de : FIND",en:["found"]},
      {fr:"Passé simple (= PP) de : HAVE",en:["had"]},
      {fr:"Passé simple (= PP) de : HEAR",en:["heard"]},
      {fr:"Passé simple (= PP) de : KEEP",en:["kept"]},
      {fr:"Passé simple (= PP) de : LEAVE",en:["left"]},
      {fr:"Passé simple (= PP) de : LOSE",en:["lost"]},
      {fr:"Passé simple (= PP) de : MAKE",en:["made"]},
      {fr:"Passé simple (= PP) de : MEET",en:["met"]},
      {fr:"Passé simple (= PP) de : PAY",en:["paid"]},
      {fr:"Passé simple (= PP) de : SAY",en:["said"]},
      {fr:"Passé simple (= PP) de : SELL",en:["sold"]},
      {fr:"Passé simple (= PP) de : SEND",en:["sent"]},
      {fr:"Passé simple (= PP) de : TELL",en:["told"]},
      {fr:"Passé simple (= PP) de : THINK",en:["thought"]},
      {fr:"Passé simple (= PP) de : WIN",en:["won"]}
    ]
  },
  "irreg-verbs-3": {
    id:"irreg-verbs-3",hidden:true,title:"Verbes irréguliers — Groupe 3",subtitle:"🟢 Les 3 formes identiques",icon:"🟢",color:"#22c55e",questionCount:5,hasQuiz:true,
    questions:[
      {fr:"Passé simple (= PP) de : CUT",en:["cut"]},
      {fr:"Passé simple (= PP) de : LET",en:["let"]},
      {fr:"Passé simple (= PP) de : PUT",en:["put"]},
      {fr:"Passé simple (= PP) de : SET",en:["set"]},
      {fr:"Passé simple (= PP) de : SHUT",en:["shut"]}
    ]
  },
  "pp-present-perfect": {
