const LESSONS = {
  ...
  "irreg-verbs-1": {
    id:"irreg-verbs-1",hidden:true,title:"Verbes irréguliers — Groupe 1",subtitle:"⚠️ V2 ≠ V3 — tape les deux formes",icon:"⚠️",color:"#f59e0b",questionCount:10,hasQuiz:true,
    questions:[
      {fr:"BREAK",en:["broke / broken"],combined:true},
      {fr:"EAT",en:["ate / eaten"],combined:true},
      {fr:"GO",en:["went / gone"],combined:true},
      {fr:"SEE",en:["saw / seen"],combined:true},
      {fr:"TAKE",en:["took / taken"],combined:true},
      {fr:"WRITE",en:["wrote / written"],combined:true},
      {fr:"SPEAK",en:["spoke / spoken"],combined:true},
      {fr:"KNOW",en:["knew / known"],combined:true},
      {fr:"GIVE",en:["gave / given"],combined:true},
      {fr:"DRINK",en:["drank / drunk"],combined:true}
    ]
  },
  "irreg-verbs-2": {
    id:"irreg-verbs-2",hidden:true,title:"Verbes irréguliers — Groupe 2",subtitle:"✅ V2 = V3 — une seule forme à taper",icon:"🟩",color:"#10b981",questionCount:20,hasQuiz:true,
    questions:[
      {fr:"BRING",en:["brought"],combined:false},
      {fr:"BUILD",en:["built"],combined:false},
      {fr:"BUY",en:["bought"],combined:false},
      {fr:"CATCH",en:["caught"],combined:false},
      {fr:"FEEL",en:["felt"],combined:false},
      {fr:"FIND",en:["found"],combined:false},
      {fr:"HAVE",en:["had"],combined:false},
      {fr:"HEAR",en:["heard"],combined:false},
      {fr:"KEEP",en:["kept"],combined:false},
      {fr:"LEAVE",en:["left"],combined:false},
      {fr:"LOSE",en:["lost"],combined:false},
      {fr:"MAKE",en:["made"],combined:false},
      {fr:"MEET",en:["met"],combined:false},
      {fr:"PAY",en:["paid"],combined:false},
      {fr:"SAY",en:["said"],combined:false},
      {fr:"SELL",en:["sold"],combined:false},
      {fr:"SEND",en:["sent"],combined:false},
      {fr:"TELL",en:["told"],combined:false},
      {fr:"THINK",en:["thought"],combined:false},
  ...
  "irreg-verbs-3": {
    ...
    questions:[
      {fr:"CUT",en:["cut"],combined:false},
      {fr:"LET",en:["let"],combined:false},
      {fr:"PUT",en:["put"],combined:false},
      {fr:"SET",en:["set"],combined:false},
      {fr:"SHUT",en:["shut"],combined:false}
    ]
  },
  "pp-present-perfect": {
